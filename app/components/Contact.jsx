...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "61e02b82-0734-4482-9940-79a02fbbccb9");
  ...
  return (
    ...
    id='contact'   className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none '>
      <motion.h4  
    ...
    I'd love to hear from you!</motion.p>
    ...
    onSubmit={onSubmit} className='max-w-2xl mx-auto'> 
      ...
      <Image src={assets.rightarrowwhite} alt='' className='w-4' />Submit now</motion.button>
